 ...
 * == END LICENSE ==
 *
 * Extended by Daniel Kaschel 2016
 *
...
namespace Jira_Issue_Creator
{
    ...
    /// </summary>
    public class OutlookDataObject : WinFrm.IDataObject
    {
        ...
        /// <summary>
        /// Holds the <see cref="WinFrm.IDataObject"/> that this class is wrapping
        /// </summary>
        private WinFrm.IDataObject underlyingDataObject;

        /// <summary>
        /// Holds the <see cref="System.Runtime.InteropServices.ComTypes.IDataObject"/> interface to the <see cref="WinFrm.IDataObject"/> that this class is wrapping.
        /// </summary>
        private System.Runtime.InteropServices.ComTypes.IDataObject comUnderlyingDataObject;

        /// <summary>
        /// Holds the internal ole <see cref="WinFrm.IDataObject"/> to the <see cref="WinFrm.IDataObject"/> that this class is wrapping.
        /// </summary>
        private WinFrm.IDataObject oleUnderlyingDataObject;

        /// <summary>
        /// Holds the <see cref="MethodInfo"/> of the "GetDataFromHGLOBLAL" method of the internal ole <see cref="WinFrm.IDataObject"/>.
        /// </summary>
        ...
        public OutlookDataObject(WinFrm.IDataObject underlyingDataObject)
        {
            ...
            oleUnderlyingDataObject = (WinFrm.IDataObject)innerDataField.GetValue(this.underlyingDataObject);
        ...
        /// <summary>
        /// Saves message to a file. Only one file allowed. By default saved to the e-mail's name.
        /// </summary>
        /// <param name="filename"></param>
        /// <returns>Returns filename if written, empty if no file was written.</returns>
        public string SaveToFile(string filename = null)
        {
            //get the names and data streams of the files dropped
            var filenames = (string[])GetData("FileGroupDescriptor");
            var filestreams = (MemoryStream[])GetData("FileContents");
            if (filenames.Length != 1) return string.Empty;

            //this section is set up as a loop for future multi-file support
